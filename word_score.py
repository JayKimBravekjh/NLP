# -*- coding: utf-8 -*-
"""
Created on Fri Mar  4 13:03:06 2016
...
def review_to_words(review):
    ...
    review_text=re.sub(r"not\s\b(.*?)\b", r"not_\l", review_text)
...
# returns a vector of zero for reviews containing words where none of them met 
# the min_count or were not seen in the training set
